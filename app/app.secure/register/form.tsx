...
const RegisterForm = () => {
  ...
  return (
    ...
    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <div>
            <label htmlFor='text' className="block text-sm font-medium leading-6 text-gray-900">User name/Full name</label>
            <div className="mt-2">
            <input id="fullName" name="fullName" type="name" required className="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6"/>
            </div>
        </div>
        <div>
